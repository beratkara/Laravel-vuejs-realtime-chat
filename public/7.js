...
!(function webpackMissingModule() { var e = new Error("Cannot find module '@services/api/SystemService'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                query = new !(function webpackMissingModule() { var e = new Error("Cannot find module '@services/api/SystemService'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())().getRoleAndPermissions();
                _context.next = 3;
                return query;
      ...
      "form",
      {
        on: {
          submit: function($event) {
            ...
            return _vm.createPersons($event)
          }
        }
      },
      [
