          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _this.loading = true;
                includes = ['info'];
                query = new !(function webpackMissingModule() { var e = new Error("Cannot find module '@services/api/PersonsService'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())().paginate(page, perPage).filter(_this.search).sort(orderBy, sortedBy).include(includes).all();
                _context.next = 6;
                return query;
